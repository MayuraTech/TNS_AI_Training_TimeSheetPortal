...
export class HolidayCalendarComponent implements OnInit {
  ...
  async addHoliday() {
    ...
    try {
      await firstValueFrom(this.http.post('/qa/api/hr/holidays', this.form, { withCredentials: true }));
  ...
  async deleteHoliday(id: number) {
    ...
    try { await firstValueFrom(this.http.delete(`/qa/api/hr/holidays/${id}`, { withCredentials: true })); this.load(); } catch { }
  }
